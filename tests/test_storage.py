...
def test_insert_and_upsert(db):
    save_product(db, Product(sku="test-1", title="Original", price=Decimal("19.99"), rating=Decimal("4.20"), reviews_total=2, has_rich_content=False))
    save_product(db, Product(sku="test-1", title="Updated", price=Decimal("21.33"), rating=Decimal("4.80"), reviews_total=5, has_rich_content=True))
