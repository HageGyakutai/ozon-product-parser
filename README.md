...
Python 3.12+, Docker Compose. Из корня проекта:
...
# опционально: python scripts/get_cookies.py --gmail
```
...
```bash
python scripts/parse_ozon.py 2359066702 2829800382
python scripts/parse_ozon.py 2359066702 2829800382 --csv output/products.csv
```
...
TEST_DATABASE_URL=postgresql+psycopg://ozon:local_only_change_me@localhost:5432/ozon_test pytest -q
```
